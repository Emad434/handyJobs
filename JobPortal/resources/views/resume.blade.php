              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-aside">
                  <div class="rd-navbar-aside-item">
                   ...
                   <div class="rd-navbar-aside">
                  <div class="rd-navbar-aside-item">
                 <button class="button button-xs button-primary-outline button-icon button-icon-left rd-navbar-popup-toggle" data-rd-navbar-toggle="#rd-navbar-register"><img class="img-thumbnail" src="{{asset('/JobPortal/public/profile_images')}}/{{$user_details->profile_image}}"style="width:30px;border-radius: 100px;"/></button>
                 </div>
                </div>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.min.css">
 ...
 $user_details = App\User::where('id',$user_details->id)->first();
 ...
 <div class="profile-header">
       ...
       <a class="nav-link active border border-primary" data-toggle="tab" href="#tab1" role="tab" aria-controls="home" aria-expanded="true"><h5>General Information</h5></a>
                     ...
                     @php
                $providerdetails= App\Gig::where('user_id',$user_details->id)->where('service_category','4')->where('status','active')->count();
  ...
  <!-- Candidate form -->
         ...
         <div class="container">
           <div class="block-form">
            ...
            <form method="post" data-form-type="contact" action="/update_profile?token={{$user_details->profile_token}}" enctype="multipart/form-data">
            	@csrf
            ...
            <div class="rd-form rd-mailform form-lg">
                ...
                <div class="col-md-6">
                  <div class="form-wrap">
                    ...
                    <div class="form-wrap-inner">
                      <input class="form-input" id="general-information-profession"type="text" value="{{$user_details->name}}" name="name" >
                      <label class="form-label" for="general-information-profession">{{$user_details->name}}</label>
                    </div>
                  </div>
                  </div>
              ...
              <label class="button button-sm button-primary-outline button-icon button-icon-left">
                <input type="file" name="photo" ><span class="icon mdi mdi-account-box"></span>{{ __(('Change Your Photo')) }}
                &nbsp &nbsp <img src="{{asset('/JobPortal/public/profile_images')}}/{{$user_details->profile_image}}" class="img-thumbnail" style="width:50px;"/>
              </label>
            </div>
            </div>
             <br>
             <br>
            <div class="col-md-6">
            <button class="button button-lg button-secondary" type="submit">{{ __(('Save Changes')) }}</button>    
            </div>
                </div>
                </div>
                </div>
 	...
 	<section class="section section-md text-center">
        ...
        @php
             $country = App\Locations::where('id',$user_details->country)->where('location_type','Country')->first();
            $city = App\Locations::where('parent_locations',$user_details->city)->where('location_type','City')->first();
            $details =  App\BankDetail::where('user_id',$user_details->id)->first();
        @endphp
  <center>
  <br>
  <br>
...
<section class="card section section-md text-center col-sm-8">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-10">
            	...
            	<form method="post" action="bank_detail_save" enctype="multipart/form-data">
				@csrf
            	...
            	<div class="container col-sm-12">
                  ...
                  <label class="form-label-outside" for="general-information-job-category">{{ __(('Full Name')) }}</label>
              	   <input type="text"  placeholder="Full Name" value="{{$details->user__name ?? ''}}" class="form-control" name="name">
              	   </div>
                ...
                <br>
                    ...
                    <br>
                        ...
                        <br>
                    <div class="container col-sm-12">
                		 <button class="button button-xs button-primary-outline button-icon button-icon-left rd-navbar-popup-toggle" style="width:100%;">{{ __(('Save Details')) }}</button>
                    </div>
            	</form>
 ...
 <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="4-tab">
		      ...
		      <div class="tab-pane-header">
		          <form method="post" action="/Providers/lience/{{$user_details->id}}">
		              @csrf
