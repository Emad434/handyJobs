...
<div id="main">
  ...
  <!-- full Editor start -->
   <form class="col s12" method="post" enctype="multipart/form-data"  action="/Blog/edit_save/{{$blog->id}}">
   	@csrf
          ...
          <div class="col s12">
           <section class="full-editor">
		    ...
		    <div class="row section">
		      ...
		      <br>
		      <div class="col s12 m12 l12">
		      	<img src="{{asset('JobPortal/public/blog_images')}}/{{$images->file_path}}"style="height: 100px;">
		      </div>
 ...
 <script type="text/javascript">
		 ...
		 document.body.addEventListener('keypress', function(e) {
		    ...
		    var textarea = document.getElementById('textarea').value = edito_clas;
