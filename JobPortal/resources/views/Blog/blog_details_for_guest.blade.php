          ...
          <div class="blog-layout">
            <div class="blog-layout-main">
              <article class="post-creative">
            	...
            	<center><img class="post-classic-image" src="{{asset('/JobPortal/public/blog_images')}}/{{$key->file_path}}" alt="" style="width:600px; height:550px;"></center>
          ...
          <div class="row row-50 row-xl-70">
            ...
            <div class="col-sm-6 col-lg-4">
              <article class="post-classic"><a class="post-classic-media" href="/Blog/Blogs-Details/{{$all_blog->id}}/{{$slug}}">
                ...
                <time class="post-classic-time" datetime="{{$all_blog->created_at}}">{{$all_blog->created_at}}</time>
