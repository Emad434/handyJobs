                  ...
                  <div class="tab-pane fade" id="tabs-1-2">
		            ...
		            <tbody>
		              ...
		              <tr>
		                ...
		                <td><img src="{{asset('/JobPortal/public/message_media')}}/{{$currency->currency_img}}" style="width:15px;"/>&nbsp{{$cmplt_contracts->contract_amount}}</td>
                   ...
                   <table class="table table-primary table-responsive-md">
		            ...
		            <tbody>
		              ...
		              <tr>
		                ...
		                <td><img src="{{asset('/JobPortal/public/message_media')}}/{{$currency->currency_img}}" style="width:15px;"/>&nbsp{{$cancelled_contracts->contract_amount}}</td>
		              ...
		              @else
		              <tr><td>{{ __(('No any orders found')) }}.</td></tr>
		              @endif
                  ...
                  <table class="table table-primary table-responsive-md">
		            ...
		            <tbody>
		              ...
		              <tr>
		                ...
		                <td><img src="{{asset('/JobPortal/public/message_media')}}/{{$currency->currency_img}}" style="width:15px;"/>&nbsp{{$pending_contracts->contract_amount}}</td>
