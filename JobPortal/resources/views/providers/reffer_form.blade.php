 ...
 <div class="jumbotron-creative-inner">
          <div class="container">
            <div class="jumbotron-creative-main">
              <h2 class="jumbotron-creative-title">{{ __(('Invite friends and earn money')) }}</h2>
             ...
             @php
                ...
                @if($user->profile_image == null)
                 ...
                 @else 
                  	...
                  	<img src="{{asset('/JobPortal/public/profile_images')}}/{{Auth::user()->profile_image}}" style="width:150px;border-radius: 100px;" class="img-thumbnail">
               
                 
              @endif
        	
          <h3>{{Auth::user()->name}} {{ __(('Invite your friends in')) }} <span class="text-primary">{{ __(('Handy')) }}</span>{{ __(('Services')) }}</h3>
          <p class="text-spacing-05">{{ __(('& You Both Get Up To $100. Introduce your friends to the easiest way to get things done')) }}
          ...
          <div class="row row-50 justify-content-center align-items-center text-left">
          	...
          	<form method="post" class="form-group" action="/Providers/invitation">
          		@csrf
          			...
          			<input type="email" placeholder="{{ __('Enter your friend email')}}" autocomplete="off" class="form-control justify-content-center" name="email" required="" style="width: 1000px;"><br>
          			 @if (session('status'))
                            <div class="alert alert-danger" style="background-color: red; color: white;">
                                {{ session('status') }}
                            </div>
                            @endif
          			<center><button class="btn btn-primary" style="border-radius:40px;">Send Invitation</button></center>
          				</div>
...
<!-- 	<div class="page-content page-container" id="page-content">
          			...
          			<div class="row">
          			 	...
          			 	<div class="card mx-auto" style="width:300px;">
          			 		...
          			 		<div class="card-body">
          			 			...
          			 			{{ __(('Spread the word by email or with your link via social sharing'))}}
          			 	...
          			 	<div class="card mx-auto" style="width:300px;">
          			 		<div class="card-body">
          			 			{{ __(('Your friend signs up to Handyservices & gets 20% off their first purchase'))}}
          			 	...
          			 	<div class="card mx-auto" style="width:300px;">
          			 		<div class="card-body">
          			 			{{ __(('You get 20% of their first order amount, up to $100'))}}
    ...
    <section class="section section-md bg-default text-center">
        <div class="container">
        	 <bold><h2 class="jumbotron-creative-title">	{{ __(("Don't Let Your Friends Waste Another Minute"))}}</h2></bold>
            
          <div class="row row-50 justify-content-center align-items-center text-left">
  			 <div class="container col-sm-10"> 

  			 	<strong><p>	{{ __(("Nobody likes to waste time. That's why HandyService empowers entrepreneurs to connect with pros who can help them do more with less. You've experienced this power. Now, you can share it and earn up to $100 for every friend who signs up and makes their first order."))}}</p></strong>
