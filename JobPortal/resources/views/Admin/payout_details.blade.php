            ...
            @endif
             ...
             <section class="invoice-view-wrapper section">
                  <div class="row">
                    ...
                    <div class="col xl9 m8 s12">
                      <div class="card">
                       ...
                       <div class="divider mb-3 mt-3"></div>
                          ...
                          <div class="row invoice-info">
                            <div class="col m6 s12">
                              <h6 class="invoice-from">Signatures</h6>
                            ...
                            <div class="col m6 s12">
                              <div class="divider show-on-small hide-on-med-and-up mb-3"></div>
                              <h6 class="invoice-to">Signatures</h6>
                   ...
                   @if($bank_details_count > 0)
 		            
                    @php
                      $bank_details = App\BankDetail::where('user_id',$contract_details->buyer_id)->first();
 		           @endphp
                     <div class="col xl3 m4 s12">
                      <div class="card invoice-action-wrapper">
                        <div class="card-content">
                           <div class="invoice-action-btn">
                              <h5>Buyer Bank Deatils</h5>
                              <hr>
                          <div class="row invoice-info">
                            <div class="col m12 s12">
                              ...
                              @php
                                $pay_out = App\Payout::where('buyer_id',$buyer_details->id)->where('contract_id',$contract_details->id)->where('invoice_id',$invoice->id)->count();
                               @endphp
                              @if($pay_out > 0)
                               <div class="invoice-action-btn">
                          ...
                          @else
                           <div class="invoice-action-btn">
                            <a href="/Admin/pay_cmplt/{{$contract_details->id}}/{{$contract_details->buyer_id}}/{{$invoice->id}}" class="btn-block btn btn-light-indigo waves-effect waves-light">
                               <span> Pay</span>
                            </a>
                          </div>
                          @endif
