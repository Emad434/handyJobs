...
@section('content')
      ...
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Total Revenue 
               </h6>
               <p class="medium-small">This billing cycle</p>
               <div class="current-balance-container">
                  <div id="current-balance-donut-chart" class="current-balance-shadow"></div>
               </div>
               <h5 class="center-align">${{$cmplted_contrracts}}</h5>
      ...
      <div class="col s12 m8 l8 animate fadeRight">
         <!-- Total Transaction -->
          <div class="card padding-4 animate fadeLeft">
            <div class="row">
               <div class="col s5 m5">
                  <h5 class="mb-0">{{$new_clients}}</h5>
                  <p class="no-margin">New</p>
                  <p class="mb-0 pt-8">{{$total_clients}}</p>
               </div>
   ...
   <div class="row">
      ...
      <div class="col s12 l4 col-sm-8">
         <!-- Recent Buyers -->
         <div class="card recent-buyers-card animate fadeUp">
            <div class="card-content">
               <h4 class="card-title mb-0">Rising Sellers</h4>
                <ul class="collection mb-0">
                    @foreach($rising_sellers as $rising_seller)
                    
                        @php
                        
                            $net_income = App\AmountStatus::where('provider_id',$rising_seller->id)->sum('amount');
                            
                            $rating = App\Reviews::where('provider_id',$rising_seller->id)->get();
                  ...
                  <li class="collection-item avatar">
                     <img src="{{asset('JobPortal/public/profile_images')}}/{{$rising_seller->profile_image}}" alt="" class="circle" />
                     <p class="font-weight-600">{{$rising_seller->name}}</p>
                     <p class="medium-small">{{$round_up}} <i class="material-icons">star</i></p>
                     <a href="/Admin/featured_seller/{{$rising_seller->id}}" class="secondary-content btn btn-primary" style="color:white;">Featured</a>
                  </li>
