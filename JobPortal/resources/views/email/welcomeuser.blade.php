...
@php
$user_details = App\User::where('id',$user->id)->first();
@endphp
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;">
  <tr>
    <td align="center" bgcolor="#70bbd9" style="padding: 40px 0 30px 0;">
      <img src="{{asset('/front_css/images/home-1-748x528.png')}}" alt="Creating Email Magic." width="300" height="230" style="display: block;" />
    </td>
  </tr>
  <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;"> Welcome to <span class="text-primary"style="color:1087EB;">Handy</span>Services </h1>
            <a href="{{asset('')}}Profile-Edit?token={{$user_details->profile_token}}">Go To Profile</a>
          </td>
        </tr>
        <tr>
