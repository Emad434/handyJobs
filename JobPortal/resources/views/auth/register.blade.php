...
$arraykey =  array_keys($contry_code);
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row d-flex justify-content-center">
                            ...
                            <label class="col-md-2 col-form-label text-md-right" for="rd-navbar-register-password" >Phone Number</label>
                       ...
                       <div class="form-group col-md-4">
                          <input class="form-control @error('number') is-invalid @enderror"  type="number" name="phone_number" data-constraints="@Required"/>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="button button-xs button-primary-outline button-icon button-icon-left rd-navbar-popup-toggle toggle-original">
                                    {{ __('Register') }}
                                </button>
                                  <p>Already have an account? <a href="/login">Login</a> Or</p>
                                  <div class="form-wrap form-wrap-ally">
                          <div class="button-group">
                              <a class="button button-facebook button-icon button-icon-only button-winona" href="{{ url('/redirect/facebook') }}" aria-label="Facebook"><span class="icon mdi mdi mdi-facebook"></span></a>
                               <a class="button button-google button-icon button-icon-only button-winona" href="{{ url('redirectToGoogle/google') }}" aria-label="Google+"><span class="icon mdi mdi-google"></span></a></div>
