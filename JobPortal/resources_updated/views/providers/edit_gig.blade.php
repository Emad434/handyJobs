   ...
   <div class="jumbotron-creative-inner">
          <div class="container">
            <div class="jumbotron-creative-main">
              <h2 class="jumbotron-creative-title">Manage Your Service Details</h2>
          ...
          <div class="block-form">
           ...
           <div class="block-form">
            ...
            <div class="group">
              ...
              <img src="{{$edit_gig->thumbnail}}" style="width: 150px;">
               
            </div>	
            <hr>
            <button class="button button-lg button-secondary" type="submit">Save</button>
          </div>
        </div>
        </form>
      </section>
