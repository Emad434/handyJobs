...
document.getElementById('laoder').style.display = "none";
  ...
  var block = ' <div class="message self"><div class="message-wrapper"><div class="message-content"><span> '+snapshot.val().text+'</span>'+image_tag+'</div></div><div class="message-options"><div class="avatar avatar-sm"><img alt="" src="{{Auth::user()->profile_image}}"></div><span class="message-date">'+snapshot.val().date+'</span></div></div> ';
