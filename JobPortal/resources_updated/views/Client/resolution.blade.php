  ...
  <section class="section section-md text-center">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-10">
            	<div class="container">
            		<form method="post" action="/Providers/request_cancel/{{$id}}/{{$buyer_id->sellers_id}}">
            			@csrf
            			...
            			<button class="btn btn-primary" onclick="myfunction" style="background-color: red;border-color: red;">Open Dispute</button>
            		</form>
            	</div>
            </div>
        </div>
