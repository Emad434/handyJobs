        ...
        <div class="profile-header">
            ...
            <div class="profile-header-content">
                <div class="profile-header-img">
                    <img src="{{$provider_details->profile_image}}" alt="" class="img-thumbnail" />
                </div>
        ...
        <div class="profile-container">
            <div class="profile-sidebar">
                <div class="desktop-sticky-top">
                    <h4>{{$provider_details->name}}</h4>
                    @php
                    $country = App\Locations::where('id',$provider_details->country)->first();
                    @endphp
                    <div class="font-weight-600 mb-3 text-muted mt-n2">{{$provider_details->email}}</div><hr>
                    <p>
                    ...
                    <div class="mb-1"><i class="fa fa-map-marker"></i> {{$country->name}}</div><hr><br>
                                         <button class="btn btn-primary"data-toggle="modal" data-target="#exampleModal">Contact me</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="/Client/send_message/{{$provider_details->id}}">
          @csrf
