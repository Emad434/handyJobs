...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/Admin_css/images/favicon/favicon-32x32.png')}}">
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <header class="page-topbar" id="header">
      <div class="navbar navbar-fixed"> 
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark no-shadow gradient-45deg-indigo-blue">
          <div class="nav-wrapper">
            ...
            <ul class="navbar-list right">
              ...
              <li><a class="waves-effect waves-block waves-light sidenav-trigger" href="#" data-target="slide-out-right"><i class="material-icons">format_indent_increase</i></a>
              </li>
            </ul>
            <!-- translation-button-->
 ...
 <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img src="{{asset('/Admin_css//images/icon/pdf-image.png')}}" width="24" height="30" alt="sample image"></div>
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark gradient-45deg-deep-purple-blue sidenav-gradient sidenav-active-rounded">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down" src="{{asset('/Admin_css/images/icon/pdf-image.png')}}" alt="materialize logo"/><img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset('/Admin_css/images/icon/pdf-image.png')}}" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Admin</span></a>
      </div>
        ...
        <li class="active bold"><a class="active gradient-shadow gradient-45deg-green-teal" href="JavaScript:void(0)"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><!-- <span class="badge badge pill orange float-right mr-10">3</span> --></a>
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
              <li><a class="" href="/Admin/User-Manage"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Modern">User Management</span></a>
              </li>
              ...
              <li><a href="/Blog/All-Blogs"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Analytics">Blogs Management</span></a>
               ...
               <li><a href="dashboard-analytics.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Analytics">Manual bonus</span></a>
              </li>
              <li><a href="/Admin/Notification"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Analytics">Send Notification</span></a>
               ...
               <li><a href="dashboard-analytics.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Analytics">All Contacts</span></a>
              </li>
               <li><a href="dashboard-analytics.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Analytics">Account Setting</span></a>
              </li>

              <li><a href="/Admin/Set-Referal-Bonus"><i class="material-icons">radio_button_unchecked</i>
                <span data-i18n="Analytics">Referal bonus setting</span></a>
              </li>
            </ul>
          </div>
        </li>   
...
var myname = "{{Auth::user()->id }}";
 ...
 if(snapshot.val().file == ""){
    ...
    image_tag = "";
      ...
      image_tag = '<a class="popup-media" href="{{asset("/message_media")}}/'+snapshot.val().files+ '"><img class="img-fluid rounded" src="{{asset("/message_media")}}/'+snapshot.val().files+'" style="width:100px;height:100px;"></a>';
