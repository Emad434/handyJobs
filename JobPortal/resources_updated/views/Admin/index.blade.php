...
@section('content')
   ...
   <div class="row vertical-modern-dashboard">
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Last Month Revenue 
               </h6>
      ...
      <div class="col s12 m8 l8 animate fadeRight">
         ...
         <div class="card">
            <div class="card-content">
               <h4 class="card-title mb-0">12 Month Revenue</h4>
   ...
   <div class="row">
      ...
      <div class="col s12 l4 col-sm-8">
         ...
         <div class="card recent-buyers-card animate fadeUp">
            <div class="card-content">
               <h4 class="card-title mb-0">Recent Buyers</h4>
